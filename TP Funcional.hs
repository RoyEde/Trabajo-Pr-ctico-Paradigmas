...
testeoDeBlockChain = hspec $ do
  describe "Testeos sobre usuarios luego de aplicar blockChain" $ do
    ...
    it "Tomando los primeros 3 bloques del blockChain y aplicandoselo a pepe nos devuelve a pepe con una billetera de 51" $ muchosBloques pepe (take 3 blockChain) `shouldBe` Usuario "Jose" (Billetera 51)
